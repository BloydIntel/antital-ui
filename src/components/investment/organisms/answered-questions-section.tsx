...
export function AnsweredQuestionsSection() {
  ...
  const questions = [
    ...
    {
      question: 'Your valuation cap seems high. What justifies the ₦37.5B?',
    ...
    },
    {
      ...
      answer: 'Our revenue model is predominantly structured in Naira for all clients, with natural hedging built in through our operational cost base. Our financial model (see the Details tab) accounts for a 15% annual currency depreciation stress test.',
    },
  ]
