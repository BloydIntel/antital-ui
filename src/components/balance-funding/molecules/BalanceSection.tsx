    ...
    return (
        <div className="bg-[#042E27] border rounded-lg px-4">
            <div className='flex justify-between items-center py-4'>
                <div>
                    <p className="text-[16px] lg:text-[20px] text-[#F4F5F7]">
                        Total available balance
                    </p>
                    <p className='text-[12px] lg:text-[16px] text-[#F4F5F7]' style={TYPOGRAPHY.body}>
                ...
                <button
                    ...
                    className='text-[16px] h-full p-2 lg:px-8 lg:py-3 flex items-center gap-2 border-[#EAEAEA] text-[#1A1C1E] bg-white hover:bg-gray-50 rounded-md cursor-pointer'
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full pt-5 lg:pt-10">
